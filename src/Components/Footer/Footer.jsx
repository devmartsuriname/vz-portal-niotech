                                    ...
                                    <div className="info">
                                        <div className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="23" viewBox="0 0 22 23" fill="none">
                                                <path d="M11 5.5L15.09 8.26L14 14H8L6.91 8.26L11 5.5Z" fill="none" stroke="#5236FF" strokeWidth="2"/>
                                                <circle cx="11" cy="11.5" r="9" fill="none" stroke="#5236FF" strokeWidth="2"/>
                                            </svg>
                                        </div>
                                        <div className="link">
