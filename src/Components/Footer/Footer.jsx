                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="23" viewBox="0 0 22 23" fill="none">
                                                <path d="M11 5.5L15.09 8.26L14 14H8L6.91 8.26L11 5.5Z" fill="none" stroke="#5833FF" strokeWidth="2"/>
                                                <circle cx="11" cy="11.5" r="9" fill="none" stroke="#5833FF" strokeWidth="2"/>
                                            </svg>
                                        </div>
                                        <div className="link">
                                    ...
                                    <div className="info">
                                        <div className="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="23" viewBox="0 0 22 23" fill="none">
                                                <path d="M3.66671 4.16699H18.3334C19.3417 4.16699 20.1667 4.99199 20.1667 6.00033V17.0003C20.1667 18.0087 19.3417 18.8337 18.3334 18.8337H3.66671C2.65837 18.8337 1.83337 18.0087 1.83337 17.0003V6.00033C1.83337 4.99199 2.65837 4.16699 3.66671 4.16699Z" stroke="#5833FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                                <path d="M20.1667 6L11 12.4167L1.83337 6" stroke="#5833FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                            </svg>
                                        </div>
                                        <div className="link">
