                ...
                <div className="row text-center">
                  <div className="col-md-3 col-6">
                    <div className="counter-item">
                      <h2 className="counter-number" style={{color: '#5833FF'}}>2000+</h2>
                      <p className="text">Verwerkte Aanvragen</p>
                    </div>
                  </div>
                  <div className="col-md-3 col-6">
                    <div className="counter-item">
                      <h2 className="counter-number" style={{color: '#5833FF'}}>15+</h2>
                      <p className="text">Jaar Ervaring</p>
                    </div>
                  </div>
                  <div className="col-md-3 col-6">
                    <div className="counter-item">
                      <h2 className="counter-number" style={{color: '#5833FF'}}>98%</h2>
                      <p className="text">Succesrate</p>
                    </div>
                  </div>
                  <div className="col-md-3 col-6">
                    <div className="counter-item">
                      <h2 className="counter-number" style={{color: '#5833FF'}}>24/7</h2>
